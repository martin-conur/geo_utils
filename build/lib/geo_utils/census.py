...
def get_census_dataset() -> gpd.GeoDataFrame:
    file = wget.download("https://github.com/martin-conur/geo_utils/blob/main/geo_utils/data/info_manzanas_censo2017.feather?raw=True")
    return gpd.read_feather(file)


def get_ismt_dataset() -> gpd.GeoDataFrame:
    file = wget.download("https://github.com/martin-conur/geo_utils/blob/main/geo_utils/data/ISMT_2022_actualizado_simplificado.feather?raw=True")
    return gpd.read_feather
